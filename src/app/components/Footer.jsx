  ...
  return (
    <>
      ...
      <footer className="w-full text-slate-400">
        {/*      <!-- Main footer --> */}
        <div className="pt-12 pb-10 text-sm border-t border-slate-900 bg-slate-800">
                    ...
                    >
                      ...
                      >
                        ...
                        <desc id="desc-tb01-dark">
                          "24 hs cuidadando tu salud mental"
                        </desc>
                        <path
                          fill="currentColor"
                          fillRule="evenodd"
